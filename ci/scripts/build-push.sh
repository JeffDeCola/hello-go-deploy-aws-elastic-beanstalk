...
echo "cp -r hello-go-deploy-aws-elastic-beanstalk/hello-go-deploy-aws-elastic-beanstalk-code/* dist"
cp -r hello-go-deploy-aws-elastic-beanstalk/hello-go-deploy-aws-elastic-beanstalk-code/* dist
echo " "
...
#echo "cd src/github.com/JeffDeCola/hello-go-deploy-aws-elastic-beanstalk/hello-go-deploy-aws-elastic-beanstalk-code"
#cd src/github.com/JeffDeCola/hello-go-deploy-aws-elastic-beanstalk/hello-go-deploy-aws-elastic-beanstalk-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-aws-elastic-beanstalk/hello-go-deploy-aws-elastic-beanstalk-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-aws-elastic-beanstalk/hello-go-deploy-aws-elastic-beanstalk-code/build-push/Dockerfile" .
#echo " "
