...
echo "The goal is to set up a go src/github.com/JeffDeCola/hello-go-deploy-aws-elastic-beanstalk directory"
...
echo "cp -R ./hello-go-deploy-aws-elastic-beanstalk src/github.com/JeffDeCola/."
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for hello-go-deploy-aws-elastic-beanstalk" | tee test/test_coverage.txt
# echo " "
